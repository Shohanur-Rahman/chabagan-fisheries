...
import { useDeletePaymentCollectionMutation, useGetCollectionsQuery, useGetPaymentCollectionMutation } from "../../../redux/features/stock/paymentCollectionApi";
...
export default function Collection() {
    ...
    const { data, isSuccess } = useGetCollectionsQuery(null);
    ...
    return (
        <>
            <IconBreadcrumbs props={breadCrumb.collectionBreadCrumb} />
            <Box mt={2}>
                <Grid container spacing={2}>
                    <Grid item xs={12} sm={12} md={4} lg={4}>
                        <PaymentCollectionForm typeId={8} info={initialValues} setState={setInitialValues} />
                    </Grid>

                    <Grid item xs={12} sm={12} md={8}>
                        <LoadDataGrid title="Collections" rows={rows} columns={columns} />
                    </Grid>
                </Grid>
            </Box>
        </>
