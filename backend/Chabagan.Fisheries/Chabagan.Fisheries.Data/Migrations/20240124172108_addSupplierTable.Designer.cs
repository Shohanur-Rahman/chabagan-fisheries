...
namespace Chabagan.Fisheries.Data.Migrations
{
    ...
    [Migration("20240124172108_addSupplierTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chabagan.Chabagan.Fisheries.Models.User.DbUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2024, 1, 24, 23, 21, 5, 655, DateTimeKind.Local).AddTicks(3101),
                            Email = "admin@gmail.com",
                            IsDeleted = false,
                            IsLock = false,
                            Name = "Admin User",
                            Password = "e4yDuw4R782qz0LM+YB2PGlkeFrwMnf0uAOI6EJ0U7I=",
                            PasswordSalt = "1DgL2ySPFbp75XsXvcAqEg==",
                            RoleId = 1
                        },
                        new
                        {
                            Id = 2L,
                            CreatedDate = new DateTime(2024, 1, 24, 23, 21, 5, 670, DateTimeKind.Local).AddTicks(4600),
                            Email = "manager@gmail.com",
                            IsDeleted = false,
                            IsLock = false,
                            Name = "Site Manager",
                            Password = "++/lzqbO02ducZbhy1ndMFLQez3mBbm9yDo+C59A4Io=",
                            PasswordSalt = "1DgL2ySPFbp75XsXvcAqEg==",
                            RoleId = 2
                        },
                        new
                        {
                            Id = 3L,
                            CreatedDate = new DateTime(2024, 1, 24, 23, 21, 5, 686, DateTimeKind.Local).AddTicks(1446),
            ...
            modelBuilder.Entity("Chabagan.Fisheries.Entities.Models.Stock.DbSupplier", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Chabagan.Fisheries.Entities.Models.Stock.DbProduct", b =>
                {
                    b.HasOne("Chabagan.Fisheries.Entities.Models.Stock.DbStockCategory", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Chabagan.Fisheries.Entities.Models.Stock.DbPurchase", b =>
                {
                    b.HasOne("Chabagan.Fisheries.Entities.Models.Stock.DbSupplier", "Supplier")
                        .WithMany()
