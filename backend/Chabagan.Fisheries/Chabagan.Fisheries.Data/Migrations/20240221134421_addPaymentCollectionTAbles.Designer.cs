...
namespace Chabagan.Fisheries.Data.Migrations
{
    ...
    [Migration("20240221134421_addPaymentCollectionTAbles")]
    partial class addPaymentCollectionTAbles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chabagan.Chabagan.Fisheries.Models.User.DbUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2024, 2, 21, 19, 44, 12, 815, DateTimeKind.Local).AddTicks(5599),
                            Email = "admin@gmail.com",
                            IsDeleted = false,
                            IsLock = false,
                            Name = "Admin User",
                            Password = "/ewFmFhxVt51uKq20Un339tCx5pKvuXAN+Lrj7391po=",
                            PasswordSalt = "l1tllzd6wyBuqx/hhmvfUQ==",
                            RoleId = 1
                        },
                        new
                        {
                            Id = 2L,
                            CreatedDate = new DateTime(2024, 2, 21, 19, 44, 12, 829, DateTimeKind.Local).AddTicks(7718),
                            Email = "manager@gmail.com",
                            IsDeleted = false,
                            IsLock = false,
                            Name = "Site Manager",
                            Password = "OxFqBh1lRhPRH2Ag1CiI+636Ogrh+wjpHEhor79k4Tc=",
                            PasswordSalt = "l1tllzd6wyBuqx/hhmvfUQ==",
                            RoleId = 2
                        },
                        new
                        {
                            Id = 3L,
                            CreatedDate = new DateTime(2024, 2, 21, 19, 44, 12, 843, DateTimeKind.Local).AddTicks(6474),
            ...
            modelBuilder.Entity("Chabagan.Fisheries.Entities.Models.Stock.DbSales", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Chabagan.Fisheries.Entities.Models.Stock.DbSalesItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Chabagan.Fisheries.Entities.Models.Stock.DbSalesReturn", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Chabagan.Fisheries.Entities.Models.Stock.DbSalesReturnItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Chabagan.Fisheries.Entities.Models.Stock.DbSalesItem", b =>
                {
                    ...
                    b.HasOne("Chabagan.Fisheries.Entities.Models.Stock.DbSales", "Purchase")
                        .WithMany("Items")
                        .HasForeignKey("PurchaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Chabagan.Fisheries.Entities.Models.Stock.DbSalesReturnItem", b =>
                {
                    ...
                    b.HasOne("Chabagan.Fisheries.Entities.Models.Stock.DbSalesReturn", "Purchase")
                        .WithMany("Items")
                        .HasForeignKey("PurchaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
